...
import supplierProductOrderDataReducer from '@store/reducers/supplierProductOrderDataReducer'
...
const rootReducer = combineReducers<any>({
  ...
  supplierProductOrderData: supplierProductOrderDataReducer as any
})
