...
import '../../User/order/orderDetail.less'
...
class User extends React.Component<Props, State> {
  ...
  componentDidMount () {
    console.log(1)
    let url = 'CanteenProcurementManager/user/productOrder/findSupplierProductOrderDetail?'
...
const mapStateToProps: MapStateToPropsParam<any, any, any> = (state: any) => {
  return {
    orderId: state.supplierProductOrderData.index
  }
}
